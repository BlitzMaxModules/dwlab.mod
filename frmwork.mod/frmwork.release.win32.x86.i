...
-FindShapeWithParameter:LTShape(ShapeType$,ParameterName$,ParameterValue$,IgnoreError%=0)="_dwlab_frmwork_LTLayer_FindShapeWithParameter"
-FindShapeWithParameterID:LTShape(ShapeTypeID:brl.reflection.TTypeID,ParameterName$,ParameterValue$,IgnoreError%=0)="_dwlab_frmwork_LTLayer_FindShapeWithParameterID"
...
-GetTextFieldText$(Name$)="_dwlab_frmwork_LTWindow_GetTextFieldText"
...
-GetClassTitle$()="_dwlab_frmwork_LTButton_GetClassTitle"
...
-Init%()="_dwlab_frmwork_LTLabel_Init"
-Draw%()="_dwlab_frmwork_LTLabel_Draw"
...
-GetClassTitle$()="_dwlab_frmwork_LTSlider_GetClassTitle"
