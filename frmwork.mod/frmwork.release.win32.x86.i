...
-ToImage%(Image:LTImage,XShift%=0,YShift%=0,Frame%=0,Channel%=4)="_dwlab_frmwork_LTDoubleMap_ToImage"
-ToPixmap:brl.pixmap.TPixmap(Pixmap:brl.pixmap.TPixmap,XShift%=0,YShift%=0,Channel%=4)="_dwlab_frmwork_LTDoubleMap_ToPixmap"
...
-TileCollisionsWithSprite%(Sprite:LTSprite,DX!,DY!,XScale!,YScale!,TileMap:LTTileMap,TileX%,TileY%,CollisionType%)="_dwlab_frmwork_LTShape_TileCollisionsWithSprite"
...
-TileCollisionsWithSprite%(Sprite:LTSprite,DX!,DY!,XScale!,YScale!,TileMap:LTTileMap,TileX%,TileY%,CollisionType%)="_dwlab_frmwork_LTGroup_TileCollisionsWithSprite"
...
-TileCollisionsWithSprite%(Sprite:LTSprite,DX!,DY!,XScale!,YScale!,TileMap:LTTileMap,TileX%,TileY%,CollisionType%)="_dwlab_frmwork_LTSprite_TileCollisionsWithSprite"
...
-HandleCollisionWithTile%(TileMap:LTTileMap,TileSprite:LTSprite,TileX%,TileY%,CollisionType%)="_dwlab_frmwork_LTSprite_HandleCollisionWithTile"
...
-PushFromTile%(TileMap:LTTileMap,Sprite:LTSprite,TileX%,TileY%)="_dwlab_frmwork_LTSprite_PushFromTile"
...
-HandleCollisionWithTile%(Sprite:LTSprite,TileMap:LTTileMap,TileSprite:LTSprite,TileX%,TileY%,CollisionType%)="_dwlab_frmwork_LTBehaviorModel_HandleCollisionWithTile"
