...
-InsertBeforeShape%(Sprite:LTSprite="bbNullObject",SpritesList:brl.linkedlist.TList="bbNullObject",BeforeShape:LTShape)="_dwlab_frmwork_LTLayer_InsertBeforeShape"
...
-AddFirst:brl.linkedlist.TLink(Shape:LTShape)="_dwlab_frmwork_LTLayer_AddFirst"
-AddLast:brl.linkedlist.TLink(Shape:LTShape)="_dwlab_frmwork_LTLayer_AddLast"
-Clear%()="_dwlab_frmwork_LTLayer_Clear"
-ValueAtIndex:LTShape(Index%)="_dwlab_frmwork_LTLayer_ValueAtIndex"
-ObjectEnumerator:brl.linkedlist.TListEnum()="_dwlab_frmwork_LTLayer_ObjectEnumerator"
-FindShapeWithParameterIDInChildShapes:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:brl.reflection.TTypeID)="_dwlab_frmwork_LTLayer_FindShapeWithParameterIDInChildShapes"
...
-ObjectEnumerator:brl.linkedlist.TListEnum()="_dwlab_frmwork_LTSpriteGroup_ObjectEnumerator"
-AddFirst:brl.linkedlist.TLink(Sprite:LTShape)="_dwlab_frmwork_LTSpriteGroup_AddFirst"
-AddLast:brl.linkedlist.TLink(Sprite:LTSprite)="_dwlab_frmwork_LTSpriteGroup_AddLast"
...
-FindShapeWithParameterIDInChildShapes:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:brl.reflection.TTypeID)="_dwlab_frmwork_LTSpriteGroup_FindShapeWithParameterIDInChildShapes"
...
-CollisionsWithSpriteMap%(SpriteMap:LTSpriteMap,Handler:LTSpriteCollisionHandler,Map:brl.map.TMap="bbNullObject")="_dwlab_frmwork_LTSprite_CollisionsWithSpriteMap"
...
-ObjectEnumerator:brl.map.TNodeEnumerator()="_dwlab_frmwork_LTSpriteMap_ObjectEnumerator"
-FindShapeWithParameterIDInChildShapes:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:brl.reflection.TTypeID)="_dwlab_frmwork_LTSpriteMap_FindShapeWithParameterIDInChildShapes"
...
.Graph:LTGraph&
.Pivot:LTSprite&
.LineSegments:brl.linkedlist.TList&
...
LeftFacing!=-1!
RightFacing!=1!
.Parameters:brl.linkedlist.TList&
.X!&
.Y!&
.Width!&
.Height!&
...
-AttachModels%(Models:brl.linkedlist.TList,Activated%=1)="_dwlab_frmwork_LTShape_AttachModels"
...
-FindShapeWithParameterID:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:brl.reflection.TTypeID,IgnoreError%=0)="_dwlab_frmwork_LTShape_FindShapeWithParameterID"
-FindShapeWithParameterIDInChildShapes:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:brl.reflection.TTypeID)="_dwlab_frmwork_LTShape_FindShapeWithParameterIDInChildShapes"
...
LTTitleGenerator^brl.blitz.Object{
...
LTImage^LTObject{
Bitmaps:brl.map.TMap&=mem:p("_dwlab_frmwork_LTImage_Bitmaps")
...
-DrawUsingTileMap%(TileMap:LTTileMap,Shapes:brl.linkedlist.TList="bbNullObject")="_dwlab_frmwork_LTDebugVisualizer_DrawUsingTileMap"
...
.FalseModels:brl.linkedlist.TList&
...
.Name$&
.ButtonList:brl.linkedlist.TList&
.MaxButtons%&
...
+Find:LTButtonAction(Keys:brl.linkedlist.TList,Name$)="_dwlab_frmwork_LTButtonAction_Find"
...
+FromPixmap:LTRasterFrameVisualizer(Pixmap:brl.pixmap.TPixmap)="_dwlab_frmwork_LTRasterFrameVisualizer_FromPixmap"
