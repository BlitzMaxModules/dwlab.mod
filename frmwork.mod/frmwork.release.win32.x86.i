...
-FindShapeWithParameterID:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:TTypeID,IgnoreError%=0)="_dwlab_frmwork_LTSpriteGroup_FindShapeWithParameterID"
...
-FindShapeWithParameterID:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:TTypeID,IgnoreError%=0)="_dwlab_frmwork_LTSpriteMap_FindShapeWithParameterID"
