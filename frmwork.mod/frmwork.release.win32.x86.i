...
+LoadFromFile:LTObject(FileName$,UseIncbin%=-1,XMLObject:LTXMLObject="bbNullObject")="_dwlab_frmwork_LTObject_LoadFromFile"
...
-InitGraphics%()="_dwlab_frmwork_LTProject_InitGraphics"
-InitSound%()="_dwlab_frmwork_LTProject_InitSound"
...
-ProcessEvents%()="_dwlab_frmwork_LTProject_ProcessEvents"
-OnEvent%(ID%)="_dwlab_frmwork_LTProject_OnEvent"
-OnCloseButton%()="_dwlab_frmwork_LTProject_OnCloseButton"
-OnWindowResize%()="_dwlab_frmwork_LTProject_OnWindowResize"
-WindowsLogic%()="_dwlab_frmwork_LTProject_WindowsLogic"
-WindowsRender%()="_dwlab_frmwork_LTProject_WindowsRender"
-ReloadWindows%()="_dwlab_frmwork_LTProject_ReloadWindows"
-SwitchTo%(Project:LTProject)="_dwlab_frmwork_LTProject_SwitchTo"
...
.GridCellXDiv%&
.GridCellYDiv%&
.GridPositionSnappingMode%&
.GridResizingSnappingMode%&
.GridColor:LTColor&
.CollisionGridCellXDiv%&
.CollisionGridCellYDiv%&
-New%()="_dwlab_frmwork_LTEditorData_New"
-Delete%()="_dwlab_frmwork_LTEditorData_Delete"
-XMLIO%(XMLObject:LTXMLObject)="_dwlab_frmwork_LTEditorData_XMLIO"
}="dwlab_frmwork_LTEditorData"
LTWorld^LTLayer{
.Camera:LTCamera&
...
-GetClassTitle$()="_dwlab_frmwork_LTLayer_GetClassTitle"
-Draw%()="_dwlab_frmwork_LTLayer_Draw"
-DrawUsingVisualizer%(Vis:LTVisualizer)="_dwlab_frmwork_LTLayer_DrawUsingVisualizer"
-Init%()="_dwlab_frmwork_LTLayer_Init"
-Act%()="_dwlab_frmwork_LTLayer_Act"
-LayerFirstSpriteCollision:LTSprite(Sprite:LTSprite)="_dwlab_frmwork_LTLayer_LayerFirstSpriteCollision"
-SpriteLayerCollisions%(Sprite:LTSprite,Handler:LTSpriteCollisionHandler)="_dwlab_frmwork_LTLayer_SpriteLayerCollisions"
-TileShapeCollisionsWithSprite%(Sprite:LTSprite,DX!,DY!,XScale!,YScale!,TileMap:LTTileMap,TileX%,TileY%,Handler:LTSpriteAndTileCollisionHandler)="_dwlab_frmwork_LTLayer_TileShapeCollisionsWithSprite"
-SetCoords%(NewX!,NewY!)="_dwlab_frmwork_LTLayer_SetCoords"
...
-AddFirst:TLink(Shape:LTShape)="_dwlab_frmwork_LTLayer_AddFirst"
-AddLast:TLink(Shape:LTShape)="_dwlab_frmwork_LTLayer_AddLast"
-Clear%()="_dwlab_frmwork_LTLayer_Clear"
-ValueAtIndex:LTShape(Index%)="_dwlab_frmwork_LTLayer_ValueAtIndex"
-ObjectEnumerator:TListEnum()="_dwlab_frmwork_LTLayer_ObjectEnumerator"
-FindShapeWithParameterIDInChildShapes:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:TTypeID)="_dwlab_frmwork_LTLayer_FindShapeWithParameterIDInChildShapes"
...
LTSpriteGroup^LTSprite{
SpriteShape:LTSprite&=mem:p("_dwlab_frmwork_LTSpriteGroup_SpriteShape")
.Children:TList&
-New%()="_dwlab_frmwork_LTSpriteGroup_New"
-Delete%()="_dwlab_frmwork_LTSpriteGroup_Delete"
-GetClassTitle$()="_dwlab_frmwork_LTSpriteGroup_GetClassTitle"
-GetChildrenEnumerator:Object()="_dwlab_frmwork_LTSpriteGroup_GetChildrenEnumerator"
-InsertSprite%(Sprite:LTSprite)="_dwlab_frmwork_LTSpriteGroup_InsertSprite"
-RemoveSprite%(Sprite:LTSprite)="_dwlab_frmwork_LTSpriteGroup_RemoveSprite"
-Draw%()="_dwlab_frmwork_LTSpriteGroup_Draw"
-DrawUsingVisualizer%(Vis:LTVisualizer)="_dwlab_frmwork_LTSpriteGroup_DrawUsingVisualizer"
-DrawGroup%(Vis:LTVisualizer,ParentShape:LTSprite)="_dwlab_frmwork_LTSpriteGroup_DrawGroup"
-SetShape%(Shape:LTSprite,Sprite:LTSprite,ParentShape:LTSprite)="_dwlab_frmwork_LTSpriteGroup_SetShape"
-ObjectEnumerator:TListEnum()="_dwlab_frmwork_LTSpriteGroup_ObjectEnumerator"
-AddFirst:TLink(Sprite:LTShape)="_dwlab_frmwork_LTSpriteGroup_AddFirst"
-AddLast:TLink(Sprite:LTSprite)="_dwlab_frmwork_LTSpriteGroup_AddLast"
-Clear%()="_dwlab_frmwork_LTSpriteGroup_Clear"
-ValueAtIndex:LTShape(Index%)="_dwlab_frmwork_LTSpriteGroup_ValueAtIndex"
-FindShapeWithParameterIDInChildShapes:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:TTypeID)="_dwlab_frmwork_LTSpriteGroup_FindShapeWithParameterIDInChildShapes"
-InsertBeforeShape%(Sprite:LTSprite="bbNullObject",SpritesList:TList="bbNullObject",BeforeShape:LTShape)="_dwlab_frmwork_LTSpriteGroup_InsertBeforeShape"
-Remove%(Shape:LTShape)="_dwlab_frmwork_LTSpriteGroup_Remove"
-RemoveAllOfTypeID%(TypeID:TTypeID)="_dwlab_frmwork_LTSpriteGroup_RemoveAllOfTypeID"
-Clone:LTShape()="_dwlab_frmwork_LTSpriteGroup_Clone"
-XMLIO%(XMLObject:LTXMLObject)="_dwlab_frmwork_LTSpriteGroup_XMLIO"
}="dwlab_frmwork_LTSpriteGroup"
...
-FieldToScreenFloat%(FieldX!,FieldY!,ScreenX# Var,ScreenY# Var)="_dwlab_frmwork_LTCamera_FieldToScreenFloat"
...
-Clone:LTShape()="_dwlab_frmwork_LTCamera_Clone"
-CopyTo%(Shape:LTShape)="_dwlab_frmwork_LTCamera_CopyTo"
+Create:LTCamera(Width!=800!,Height!=600!,UnitSize!=25!)="_dwlab_frmwork_LTCamera_Create"
-XMLIO%(XMLObject:LTXMLObject)="_dwlab_frmwork_LTCamera_XMLIO"
}="dwlab_frmwork_LTCamera"
L_InitGraphics%(Width%=800,Height%=600,UnitSize!=25!,ColorDepth%=0,Frequency%=60)="dwlab_frmwork_L_InitGraphics"
...
-Delete%()="_dwlab_frmwork_LTSpriteCollisionHandler_Delete"
-HandleCollision%(Sprite1:LTSprite,Sprite2:LTSprite)="_dwlab_frmwork_LTSpriteCollisionHandler_HandleCollision"
}="dwlab_frmwork_LTSpriteCollisionHandler"
...
LTCollision^Object{
ServicePivot1:LTSprite&=mem:p("_dwlab_frmwork_LTCollision_ServicePivot1")
ServicePivot2:LTSprite&=mem:p("_dwlab_frmwork_LTCollision_ServicePivot2")
ServicePivot3:LTSprite&=mem:p("_dwlab_frmwork_LTCollision_ServicePivot3")
ServicePivot4:LTSprite&=mem:p("_dwlab_frmwork_LTCollision_ServicePivot4")
ServicePivots:LTSprite&[]&=mem:p("_dwlab_frmwork_LTCollision_ServicePivots")
ServiceOval1:LTSprite&=mem:p("_dwlab_frmwork_LTCollision_ServiceOval1")
ServiceOval2:LTSprite&=mem:p("_dwlab_frmwork_LTCollision_ServiceOval2")
ServiceLine1:LTLine&=mem:p("_dwlab_frmwork_LTCollision_ServiceLine1")
ServiceLine2:LTLine&=mem:p("_dwlab_frmwork_LTCollision_ServiceLine2")
ServiceLineSegment:LTLineSegment&=mem:p("_dwlab_frmwork_LTCollision_ServiceLineSegment")
...
+OvalWithLineSegment%(Oval:LTSprite,LSPivot1:LTSprite,LSPivot2:LTSprite)="_dwlab_frmwork_LTCollision_OvalWithLineSegment"
+OvalWithTriangle%(Oval:LTSprite,Triangle:LTSprite)="_dwlab_frmwork_LTCollision_OvalWithTriangle"
+OvalWithRay%(Oval:LTSprite,Ray:LTSprite)="_dwlab_frmwork_LTCollision_OvalWithRay"
...
+RectangleWithLineSegment%(Rectangle:LTSprite,LSPivot1:LTSprite,LSPivot2:LTSprite)="_dwlab_frmwork_LTCollision_RectangleWithLineSegment"
+RectangleWithRay%(Rectangle:LTSprite,Ray:LTSprite)="_dwlab_frmwork_LTCollision_RectangleWithRay"
+TriangleWithTriangle%(Triangle1:LTSprite,Triangle2:LTSprite)="_dwlab_frmwork_LTCollision_TriangleWithTriangle"
+TriangleWithLineSegment%(Triangle:LTSprite,LSPivot1:LTSprite,LSPivot2:LTSprite)="_dwlab_frmwork_LTCollision_TriangleWithLineSegment"
+TriangleWithRay%(Triangle:LTSprite,Ray:LTSprite)="_dwlab_frmwork_LTCollision_TriangleWithRay"
+RayWithLineSegment%(Ray:LTSprite,LSPivot1:LTSprite,LSPivot2:LTSprite)="_dwlab_frmwork_LTCollision_RayWithLineSegment"
+LineSegmentWithLineSegment%(LS1Pivot1:LTSprite,LS1Pivot2:LTSprite,LS2Pivot1:LTSprite,LS2Pivot2:LTSprite)="_dwlab_frmwork_LTCollision_LineSegmentWithLineSegment"
+RayWithRay%(Ray1:LTSprite,Ray2:LTSprite)="_dwlab_frmwork_LTCollision_RayWithRay"
+RasterWithRaster%(Raster1:LTSprite,Raster2:LTSprite)="_dwlab_frmwork_LTCollision_RasterWithRaster"
}="dwlab_frmwork_LTCollision"
LTOverlap^Object{
ServicePivot1:LTSprite&=mem:p("_dwlab_frmwork_LTOverlap_ServicePivot1")
ServicePivot2:LTSprite&=mem:p("_dwlab_frmwork_LTOverlap_ServicePivot2")
ServiceOval1:LTSprite&=mem:p("_dwlab_frmwork_LTOverlap_ServiceOval1")
-New%()="_dwlab_frmwork_LTOverlap_New"
-Delete%()="_dwlab_frmwork_LTOverlap_Delete"
+CircleAndPivot%(Circle:LTSprite,Pivot:LTSprite)="_dwlab_frmwork_LTOverlap_CircleAndPivot"
+CircleAndOval%(Circle:LTSprite,Oval:LTSprite)="_dwlab_frmwork_LTOverlap_CircleAndOval"
+CircleAndCircle%(Circle1:LTSprite,Circle2:LTSprite)="_dwlab_frmwork_LTOverlap_CircleAndCircle"
+CircleAndRectangle%(Circle:LTSprite,Rectangle:LTSprite)="_dwlab_frmwork_LTOverlap_CircleAndRectangle"
+CircleAndTriangle%(Circle:LTSprite,Triangle:LTSprite)="_dwlab_frmwork_LTOverlap_CircleAndTriangle"
+RectangleAndPivot%(Rectangle:LTSprite,Pivot:LTSprite)="_dwlab_frmwork_LTOverlap_RectangleAndPivot"
+RectangleAndRectangle%(Rectangle1:LTSprite,Rectangle2:LTSprite)="_dwlab_frmwork_LTOverlap_RectangleAndRectangle"
}="dwlab_frmwork_LTOverlap"
LTWedge^Object{
ServiceLines:LTLine&[]&=mem:p("_dwlab_frmwork_LTWedge_ServiceLines")
ServicePivots:LTSprite&[]&=mem:p("_dwlab_frmwork_LTWedge_ServicePivots")
ServiceOval1:LTSprite&=mem:p("_dwlab_frmwork_LTWedge_ServiceOval1")
ServiceOval2:LTSprite&=mem:p("_dwlab_frmwork_LTWedge_ServiceOval2")
-New%()="_dwlab_frmwork_LTWedge_New"
-Delete%()="_dwlab_frmwork_LTWedge_Delete"
+PivotAndOval%(Pivot:LTSprite,Oval:LTSprite,DX! Var,DY! Var)="_dwlab_frmwork_LTWedge_PivotAndOval"
+PivotAndRectangle%(Pivot:LTSprite,Rectangle:LTSprite,DX! Var,DY! Var)="_dwlab_frmwork_LTWedge_PivotAndRectangle"
+PivotAndTriangle%(Pivot:LTSprite,Triangle:LTSprite,DX! Var,DY! Var)="_dwlab_frmwork_LTWedge_PivotAndTriangle"
+OvalAndOval%(Oval1:LTSprite,Oval2:LTSprite,DX! Var,DY! Var)="_dwlab_frmwork_LTWedge_OvalAndOval"
+OvalAndRectangle%(Oval:LTSprite,Rectangle:LTSprite,DX! Var,DY! Var)="_dwlab_frmwork_LTWedge_OvalAndRectangle"
...
+PopAngle%(Triangle1:LTSprite,Triangle2:LTSprite,DY! Var)="_dwlab_frmwork_LTWedge_PopAngle"
...
TopLeftTriangle%=4
TopRightTriangle%=5
BottomLeftTriangle%=6
BottomRightTriangle%=7
Raster%=8
.ShapeType%&
.Angle!&
.DisplayingAngle!&
...
-GetClassTitle$()="_dwlab_frmwork_LTSprite_GetClassTitle"
+FromShapeType:LTSprite(ShapeType%=2)="_dwlab_frmwork_LTSprite_FromShapeType"
+FromShape:LTSprite(X!=0!,Y!=0!,Width!=1!,Height!=1!,ShapeType%=2,Angle!=0!,Velocity!=1!)="_dwlab_frmwork_LTSprite_FromShape"
...
-LayerFirstSpriteCollision:LTSprite(Sprite:LTSprite)="_dwlab_frmwork_LTSprite_LayerFirstSpriteCollision"
...
-BounceInside%(Shape:LTShape,LeftSide%=1,TopSide%=1,RightSide%=1,BottomSide%=1)="_dwlab_frmwork_LTSprite_BounceInside"
...
-ToCircle:LTSprite(Pivot1:LTSprite,CircleSprite:LTSprite="bbNullObject")="_dwlab_frmwork_LTSprite_ToCircle"
...
-ToLine:LTLine(Line:LTLine)="_dwlab_frmwork_LTSprite_ToLine"
-HasPoint%(X1!,Y1!)="_dwlab_frmwork_LTSprite_HasPoint"
-HasPivot%(Pivot:LTSprite)="_dwlab_frmwork_LTSprite_HasPivot"
+GetMedium:LTSprite(Pivot1:LTSprite,Pivot2:LTSprite,ToPivot:LTSprite="bbNullObject")="_dwlab_frmwork_LTSprite_GetMedium"
-GetHypotenuse:LTLine(Line:LTLine="bbNullObject")="_dwlab_frmwork_LTSprite_GetHypotenuse"
-GetRightAngleVertex:LTSprite(Vertex:LTSprite="bbNullObject")="_dwlab_frmwork_LTSprite_GetRightAngleVertex"
-GetOtherVertices%(Pivot1:LTSprite,Pivot2:LTSprite)="_dwlab_frmwork_LTSprite_GetOtherVertices"
...
LTTileMapPosition^Object{
.X%&
.Y%&
.PrevPosition:LTTileMapPosition&
.NextPosition:LTTileMapPosition&
...
-Spread:LTTileMapPosition(TileMapPathFinder:LTTileMapPathFinder,FinalX%,FinalY%,List:TList,Range%)="_dwlab_frmwork_LTTileMapPosition_Spread"
...
-GetTileForPoint%(X!,Y!,TileX% Var,TileY% Var)="_dwlab_frmwork_LTTileMap_GetTileForPoint"
-GetClassTitle$()="_dwlab_frmwork_LTTileMap_GetClassTitle"
...
-Delete%()="_dwlab_frmwork_LTDoubleMap_Delete"
+Create:LTDoubleMap(XQuantity%,YQuantity%)="_dwlab_frmwork_LTDoubleMap_Create"
...
-ToNewPixmap:TPixmap(Channel%=4)="_dwlab_frmwork_LTDoubleMap_ToNewPixmap"
-PasteToImage%(Image:LTImage,XShift%=0,YShift%=0,Frame%=0,Channel%=4)="_dwlab_frmwork_LTDoubleMap_PasteToImage"
-PasteToPixmap%(Pixmap:TPixmap,XShift%=0,YShift%=0,Channel%=4)="_dwlab_frmwork_LTDoubleMap_PasteToPixmap"
...
-GetClassTitle$()="_dwlab_frmwork_LTSpriteMap_GetClassTitle"
...
-GetSprites:TMap()="_dwlab_frmwork_LTSpriteMap_GetSprites"
...
-FindShapeWithParameterIDInChildShapes:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:TTypeID)="_dwlab_frmwork_LTSpriteMap_FindShapeWithParameterIDInChildShapes"
-InsertBeforeShape%(Sprite:LTSprite="bbNullObject",SpritesList:TList="bbNullObject",BeforeShape:LTShape)="_dwlab_frmwork_LTSpriteMap_InsertBeforeShape"
-Remove%(Shape:LTShape)="_dwlab_frmwork_LTSpriteMap_Remove"
-RemoveAllOfTypeID%(TypeID:TTypeID)="_dwlab_frmwork_LTSpriteMap_RemoveAllOfTypeID"
-ObjectEnumerator:TNodeEnumerator()="_dwlab_frmwork_LTSpriteMap_ObjectEnumerator"
-Init%()="_dwlab_frmwork_LTSpriteMap_Init"
-Act%()="_dwlab_frmwork_LTSpriteMap_Act"
...
LTLine^LTShape{
ServiceLine:LTLine&=mem:p("_dwlab_frmwork_LTLine_ServiceLine")
.A!&
.B!&
.C!&
.S!&
...
-UsePoints%(X1!,Y1!,X2!,Y2!)="_dwlab_frmwork_LTLine_UsePoints"
-UsePivots%(Pivot1:LTShape,Pivot2:LTShape)="_dwlab_frmwork_LTLine_UsePivots"
-CalculateS!()="_dwlab_frmwork_LTLine_CalculateS"
-GetX!(Y!)="_dwlab_frmwork_LTLine_GetX"
-GetY!(X!)="_dwlab_frmwork_LTLine_GetY"
...
-PivotProjection:LTSprite(Pivot:LTSprite,Projection:LTSprite="bbNullObject")="_dwlab_frmwork_LTLine_PivotProjection"
-IntersectionWithLine:LTSprite(Line:LTLine,Pivot:LTSprite="bbNullObject")="_dwlab_frmwork_LTLine_IntersectionWithLine"
-IntersectionWithLineSegment:LTSprite(LSPivot1:LTSprite,LSPivot2:LTSprite,Pivot:LTSprite="bbNullObject")="_dwlab_frmwork_LTLine_IntersectionWithLineSegment"
...
-CollisionPointsWithCircle%(Circle:LTSprite,Pivot1:LTSprite,Pivot2:LTSprite)="_dwlab_frmwork_LTLine_CollisionPointsWithCircle"
...
-DrawLineSegmentsUsing%(Visualizer:LTVisualizer)="_dwlab_frmwork_LTGraph_DrawLineSegmentsUsing"
+DrawPath%(Path:TList,Visualizer:LTVisualizer)="_dwlab_frmwork_LTGraph_DrawPath"
-AddPivot:TList(Pivot:LTSprite)="_dwlab_frmwork_LTGraph_AddPivot"
-AddLineSegment%(Line:LTLineSegment,StopOnErrors%=1)="_dwlab_frmwork_LTGraph_AddLineSegment"
-RemovePivot%(Pivot:LTSprite)="_dwlab_frmwork_LTGraph_RemovePivot"
-RemoveLineSegment%(Line:LTLineSegment)="_dwlab_frmwork_LTGraph_RemoveLineSegment"
-FindPivotCollidingWithSprite:LTSprite(Sprite:LTSprite)="_dwlab_frmwork_LTGraph_FindPivotCollidingWithSprite"
-FindLineCollidingWithSprite:LTLineSegment(Sprite:LTSprite)="_dwlab_frmwork_LTGraph_FindLineCollidingWithSprite"
-ContainsPivot%(Pivot:LTSprite)="_dwlab_frmwork_LTGraph_ContainsPivot"
-ContainsLineSegment%(Line:LTLineSegment)="_dwlab_frmwork_LTGraph_ContainsLineSegment"
-FindLineSegment:LTLineSegment(Pivot1:LTSprite,Pivot2:LTSprite)="_dwlab_frmwork_LTGraph_FindLineSegment"
-FindPath:TList(FromPivot:LTSprite,ToPivot:LTSprite)="_dwlab_frmwork_LTGraph_FindPath"
-Spread:TList(Path:TList,FromPivot:LTSprite,ToPivot:LTSprite,Length!)="_dwlab_frmwork_LTGraph_Spread"
...
.Graph:LTGraph&
.LineSegment:LTLineSegment&
-New%()="_dwlab_frmwork_LTAddLineToGraph_New"
-Delete%()="_dwlab_frmwork_LTAddLineToGraph_Delete"
+Create:LTAddLineToGraph(Graph:LTGraph,LineSegment:LTLineSegment)="_dwlab_frmwork_LTAddLineToGraph_Create"
...
+Create:LTRemoveLineFromGraph(Graph:LTGraph,LineSegment:LTLineSegment)="_dwlab_frmwork_LTRemoveLineFromGraph_Create"
...
-PrintText%(Text$,Size!=1!,HorizontalAlign%=1,VerticalAlign%=1,HorizontalShift!=0!,VerticalShift!=0!,Contour%=0)="_dwlab_frmwork_LTShape_PrintText"
...
-TileShapeCollisionsWithSprite%(Sprite:LTSprite,DX!,DY!,XScale!,YScale!,TileMap:LTTileMap,TileX%,TileY%,Handler:LTSpriteAndTileCollisionHandler)="_dwlab_frmwork_LTShape_TileShapeCollisionsWithSprite"
...
-Distance2To!(Shape:LTShape)="_dwlab_frmwork_LTShape_Distance2To"
...
-MoveTowardsPoint%(DestinationX!,DestinationY!,Velocity!)="_dwlab_frmwork_LTShape_MoveTowardsPoint"
...
-SetSizeAs%(Shape:LTShape)="_dwlab_frmwork_LTShape_SetSizeAs"
...
-AttachModels%(Models:TList,Activated%=1)="_dwlab_frmwork_LTShape_AttachModels"
...
-GetParameter$(Name$)="_dwlab_frmwork_LTShape_GetParameter"
...
-GetChildrenEnumerator:Object()="_dwlab_frmwork_LTShape_GetChildrenEnumerator"
-FindShape:LTShape(Name$,IgnoreError%=0)="_dwlab_frmwork_LTShape_FindShape"
-FindShapeWithType:LTShape(ShapeType$,Name$=$"",IgnoreError%=0)="_dwlab_frmwork_LTShape_FindShapeWithType"
-FindShapeWithParameter:LTShape(ParameterName$,ParameterValue$,ShapeType$=$"",IgnoreError%=0)="_dwlab_frmwork_LTShape_FindShapeWithParameter"
-FindShapeWithParameterID:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:TTypeID,IgnoreError%=0)="_dwlab_frmwork_LTShape_FindShapeWithParameterID"
-FindShapeWithParameterIDInChildShapes:LTShape(ParameterName$,ParameterValue$,ShapeTypeID:TTypeID)="_dwlab_frmwork_LTShape_FindShapeWithParameterIDInChildShapes"
-InsertBeforeShape%(Sprite:LTSprite="bbNullObject",SpritesList:TList="bbNullObject",BeforeShape:LTShape)="_dwlab_frmwork_LTShape_InsertBeforeShape"
-Remove%(Shape:LTShape)="_dwlab_frmwork_LTShape_Remove"
-RemoveAllOfType%(TypeName$)="_dwlab_frmwork_LTShape_RemoveAllOfType"
-RemoveAllOfTypeID%(TypeID:TTypeID)="_dwlab_frmwork_LTShape_RemoveAllOfTypeID"
...
.Name$&
.Value$&
-New%()="_dwlab_frmwork_LTParameter_New"
-Delete%()="_dwlab_frmwork_LTParameter_Delete"
-XMLIO%(XMLObject:LTXMLObject)="_dwlab_frmwork_LTParameter_XMLIO"
}="dwlab_frmwork_LTParameter"
LTTitleGenerator^Object{
-New%()="_dwlab_frmwork_LTTitleGenerator_New"
...
+FromWidthAndRGBColor:LTContourVisualizer(Width!,Red!=1!,Green!=1!,Blue!=1!,Alpha!=1!,PivotScale!=1!)="_dwlab_frmwork_LTContourVisualizer_FromWidthAndRGBColor"
+FromWidthAndHexColor:LTContourVisualizer(Width!,HexColor$=$"FFFFFF",Alpha!=1!,PivotScale!=1!)="_dwlab_frmwork_LTContourVisualizer_FromWidthAndHexColor"
-DrawUsingSprite%(Sprite:LTSprite,SpriteShape:LTSprite="bbNullObject")="_dwlab_frmwork_LTContourVisualizer_DrawUsingSprite"
-DrawUsingLineSegment%(LineSegment:LTLineSegment)="_dwlab_frmwork_LTContourVisualizer_DrawUsingLineSegment"
-SetProperLineWidth%()="_dwlab_frmwork_LTContourVisualizer_SetProperLineWidth"
}="dwlab_frmwork_LTContourVisualizer"
LTMarchingAnts^LTVisualizer{
-New%()="_dwlab_frmwork_LTMarchingAnts_New"
-Delete%()="_dwlab_frmwork_LTMarchingAnts_Delete"
-DrawUsingSprite%(Sprite:LTSprite,SpriteShape:LTSprite="bbNullObject")="_dwlab_frmwork_LTMarchingAnts_DrawUsingSprite"
-DrawUsingTileMap%(TileMap:LTTileMap,Shapes:TList="bbNullObject")="_dwlab_frmwork_LTMarchingAnts_DrawUsingTileMap"
+DrawMARect%(X%,Y%,Width%,Height%)="_dwlab_frmwork_LTMarchingAnts_DrawMARect"
+MakeMALine:TImage(Width%,Pos% Var)="_dwlab_frmwork_LTMarchingAnts_MakeMALine"
+DrawMALine%(Image:TImage,X1%,Y1%,X2%,Y2%)="_dwlab_frmwork_LTMarchingAnts_DrawMALine"
...
-DrawUsingSprite%(Sprite:LTSprite,SpriteShape:LTSprite="bbNullObject")="_dwlab_frmwork_LTWindowedVisualizer_DrawUsingSprite"
...
-DrawUsingSprite%(Sprite:LTSprite,SpriteShape:LTSprite="bbNullObject")="_dwlab_frmwork_LTDebugVisualizer_DrawUsingSprite"
-DrawUsingTileMap%(TileMap:LTTileMap,Shapes:TList="bbNullObject")="_dwlab_frmwork_LTDebugVisualizer_DrawUsingTileMap"
...
-DrawSpriteMapTile%(SpriteMap:LTSpriteMap,X!,Y!)="_dwlab_frmwork_LTDebugVisualizer_DrawSpriteMapTile"
}="dwlab_frmwork_LTDebugVisualizer"
LTVisualizer^LTColor{
.DX!&
.DY!&
.XScale!&
.YScale!&
...
+FromRGBColor:LTVisualizer(Red!,Green!,Blue!,Alpha!=1!)="_dwlab_frmwork_LTVisualizer_FromRGBColor"
+FromHexColor:LTVisualizer(HexColor$=$"FFFFFF",Alpha!=1!)="_dwlab_frmwork_LTVisualizer_FromHexColor"
...
-DrawUsingSprite%(Sprite:LTSprite,SpriteShape:LTSprite="bbNullObject")="_dwlab_frmwork_LTVisualizer_DrawUsingSprite"
-DrawSpriteShape%(Sprite:LTSprite,SpriteShape:LTSprite="bbNullObject")="_dwlab_frmwork_LTVisualizer_DrawSpriteShape"
-DrawIsoRectangle%(X!,Y!,Width!,Height!)="_dwlab_frmwork_LTVisualizer_DrawIsoRectangle"
-DrawIsoOval%(X!,Y!,Width!,Height!)="_dwlab_frmwork_LTVisualizer_DrawIsoOval"
-DrawUsingLineSegment%(LineSegment:LTLineSegment)="_dwlab_frmwork_LTVisualizer_DrawUsingLineSegment"
-DrawUsingTileMap%(TileMap:LTTileMap,Shapes:TList="bbNullObject")="_dwlab_frmwork_LTVisualizer_DrawUsingTileMap"
...
.Blue!&
.Alpha!&
-New%()="_dwlab_frmwork_LTColor_New"
-Delete%()="_dwlab_frmwork_LTColor_Delete"
+FromRGB:LTColor(Red!,Green!,Blue!,Alpha!=1!)="_dwlab_frmwork_LTColor_FromRGB"
+FromHex:LTColor(HexColor$=$"FFFFFF",Alpha!=1!)="_dwlab_frmwork_LTColor_FromHex"
-SetColorFromHex%(S$)="_dwlab_frmwork_LTColor_SetColorFromHex"
-SetColorFromRGB%(NewRed!,NewGreen!,NewBlue!)="_dwlab_frmwork_LTColor_SetColorFromRGB"
-SetRandomColor%()="_dwlab_frmwork_LTColor_SetRandomColor"
-AlterColor%(D1!,D2!)="_dwlab_frmwork_LTColor_AlterColor"
-ApplyColor%()="_dwlab_frmwork_LTColor_ApplyColor"
-ApplyClsColor%()="_dwlab_frmwork_LTColor_ApplyClsColor"
+ResetColor%()="_dwlab_frmwork_LTColor_ResetColor"
-CopyColorTo%(Color:LTColor)="_dwlab_frmwork_LTColor_CopyColorTo"
-XMLIO%(XMLObject:LTXMLObject)="_dwlab_frmwork_LTColor_XMLIO"
}="dwlab_frmwork_LTColor"
LTFixedWaitingModel^LTTemporaryModel{
-New%()="_dwlab_frmwork_LTFixedWaitingModel_New"
-Delete%()="_dwlab_frmwork_LTFixedWaitingModel_Delete"
+Create:LTFixedWaitingModel(Time!)="_dwlab_frmwork_LTFixedWaitingModel_Create"
}="dwlab_frmwork_LTFixedWaitingModel"
LTRandomWaitingModel^LTTemporaryModel{
.TimeFrom!&
.TimeTo!&
-New%()="_dwlab_frmwork_LTRandomWaitingModel_New"
-Delete%()="_dwlab_frmwork_LTRandomWaitingModel_Delete"
...
.Permanent%&
-New%()="_dwlab_frmwork_LTModelActivator_New"
-Delete%()="_dwlab_frmwork_LTModelActivator_Delete"
+Create:LTModelActivator(Model:LTBehaviorModel,Permanent%=0)="_dwlab_frmwork_LTModelActivator_Create"
-ApplyTo%(Shape:LTShape)="_dwlab_frmwork_LTModelActivator_ApplyTo"
-Info$(Shape:LTShape)="_dwlab_frmwork_LTModelActivator_Info"
}="dwlab_frmwork_LTModelActivator"
LTModelDeactivator^LTBehaviorModel{
.Model:LTBehaviorModel&
.Permanent%&
-New%()="_dwlab_frmwork_LTModelDeactivator_New"
-Delete%()="_dwlab_frmwork_LTModelDeactivator_Delete"
+Create:LTModelDeactivator(Model:LTBehaviorModel,Permanent%=0)="_dwlab_frmwork_LTModelDeactivator_Create"
-ApplyTo%(Shape:LTShape)="_dwlab_frmwork_LTModelDeactivator_ApplyTo"
-Info$(Shape:LTShape)="_dwlab_frmwork_LTModelDeactivator_Info"
}="dwlab_frmwork_LTModelDeactivator"
LTModelStack^LTBehaviorModel{
.Models:TList&
-New%()="_dwlab_frmwork_LTModelStack_New"
-Delete%()="_dwlab_frmwork_LTModelStack_Delete"
-ApplyTo%(Shape:LTShape)="_dwlab_frmwork_LTModelStack_ApplyTo"
...
.TrueModels:TList&
.FalseModels:TList&
-New%()="_dwlab_frmwork_LTConditionalModel_New"
-Delete%()="_dwlab_frmwork_LTConditionalModel_Delete"
-Condition%(Shape:LTShape)="_dwlab_frmwork_LTConditionalModel_Condition"
-ApplyTo%(Shape:LTShape)="_dwlab_frmwork_LTConditionalModel_ApplyTo"
}="dwlab_frmwork_LTConditionalModel"
...
-ActivateModel%(Shape:LTShape)F="_dwlab_frmwork_LTBehaviorModel_ActivateModel"
-DeactivateModel%(Shape:LTShape)F="_dwlab_frmwork_LTBehaviorModel_DeactivateModel"
-Remove%(Shape:LTShape)F="_dwlab_frmwork_LTBehaviorModel_Remove"
-RemoveSame%(Shape:LTShape)F="_dwlab_frmwork_LTBehaviorModel_RemoveSame"
-Info$(Shape:LTShape)="_dwlab_frmwork_LTBehaviorModel_Info"
...
LTKeyboardKey^LTPushable{
.Code%&
-New%()="_dwlab_frmwork_LTKeyboardKey_New"
-Delete%()="_dwlab_frmwork_LTKeyboardKey_Delete"
-GetName$()="_dwlab_frmwork_LTKeyboardKey_GetName"
-IsEqualTo%(Pushable:LTPushable)="_dwlab_frmwork_LTKeyboardKey_IsEqualTo"
-ProcessEvent%(ID%)="_dwlab_frmwork_LTKeyboardKey_ProcessEvent"
+Create:LTKeyboardKey(Code%)="_dwlab_frmwork_LTKeyboardKey_Create"
-XMLIO%(XMLObject:LTXMLObject)="_dwlab_frmwork_LTKeyboardKey_XMLIO"
}="dwlab_frmwork_LTKeyboardKey"
LTMouseButton^LTPushable{
.Num%&
-New%()="_dwlab_frmwork_LTMouseButton_New"
-Delete%()="_dwlab_frmwork_LTMouseButton_Delete"
-GetName$()="_dwlab_frmwork_LTMouseButton_GetName"
-IsEqualTo%(Pushable:LTPushable)="_dwlab_frmwork_LTMouseButton_IsEqualTo"
-ProcessEvent%(ID%)="_dwlab_frmwork_LTMouseButton_ProcessEvent"
+Create:LTMouseButton(Num%)="_dwlab_frmwork_LTMouseButton_Create"
-XMLIO%(XMLObject:LTXMLObject)="_dwlab_frmwork_LTMouseButton_XMLIO"
}="dwlab_frmwork_LTMouseButton"
LTMouseWheelAction^LTPushable{
.Z%&
.Direction%&
-New%()="_dwlab_frmwork_LTMouseWheelAction_New"
-Delete%()="_dwlab_frmwork_LTMouseWheelAction_Delete"
-GetName$()="_dwlab_frmwork_LTMouseWheelAction_GetName"
-Reset%()="_dwlab_frmwork_LTMouseWheelAction_Reset"
-IsEqualTo%(Pushable:LTPushable)="_dwlab_frmwork_LTMouseWheelAction_IsEqualTo"
-ProcessEvent%(ID%)="_dwlab_frmwork_LTMouseWheelAction_ProcessEvent"
+Create:LTMouseWheelAction(Direction%)="_dwlab_frmwork_LTMouseWheelAction_Create"
-XMLIO%(XMLObject:LTXMLObject)="_dwlab_frmwork_LTMouseWheelAction_XMLIO"
}="dwlab_frmwork_LTMouseWheelAction"
LTPushable^LTObject{
JustPressed%=0
Pressed%=1
JustUnpressed%=2
Unpressed%=3
.State%&
-New%()="_dwlab_frmwork_LTPushable_New"
-Delete%()="_dwlab_frmwork_LTPushable_Delete"
-GetName$()="_dwlab_frmwork_LTPushable_GetName"
-ProcessEvent%(ID%)="_dwlab_frmwork_LTPushable_ProcessEvent"
-Reset%()="_dwlab_frmwork_LTPushable_Reset"
-IsDown%()="_dwlab_frmwork_LTPushable_IsDown"
-IsEqualTo%(Pushable:LTPushable)="_dwlab_frmwork_LTPushable_IsEqualTo"
-WasPressed%()="_dwlab_frmwork_LTPushable_WasPressed"
-WasUnpressed%()="_dwlab_frmwork_LTPushable_WasUnpressed"
}="dwlab_frmwork_LTPushable"
LTButtonAction^LTObject{
.Name$&
.ButtonList:TList&
.MaxButtons%&
-New%()="_dwlab_frmwork_LTButtonAction_New"
-Delete%()="_dwlab_frmwork_LTButtonAction_Delete"
...
-WasUnpressed%()="_dwlab_frmwork_LTButtonAction_WasUnpressed"
+Find:LTButtonAction(Keys:TList,Name$)="_dwlab_frmwork_LTButtonAction_Find"
-XMLIO%(XMLObject:LTXMLObject)="_dwlab_frmwork_LTButtonAction_XMLIO"
}="dwlab_frmwork_LTButtonAction"
LTDrag^LTObject{
.DraggingState%&
...
-AttributeExists%(AttrName$)="_dwlab_frmwork_LTXMLObject_AttributeExists"
...
-ManageIntArrayAttribute%(AttrName$,IntArray%&[] Var,ChunkLength%=0)="_dwlab_frmwork_LTXMLObject_ManageIntArrayAttribute"
-ManageObjectField:LTObject(FieldName$,FieldObject:LTObject)="_dwlab_frmwork_LTXMLObject_ManageObjectField"
-ManageListField%(FieldName$,List:TList Var)="_dwlab_frmwork_LTXMLObject_ManageListField"
-ManageObjectArrayField%(FieldName$,Array:LTObject&[] Var)="_dwlab_frmwork_LTXMLObject_ManageObjectArrayField"
-ManageObjectMapField%(FieldName$,Map:TMap Var)="_dwlab_frmwork_LTXMLObject_ManageObjectMapField"
-ManageObjectSetField%(FieldName$,Map:TMap Var)="_dwlab_frmwork_LTXMLObject_ManageObjectSetField"
-ManageObject:LTObject(Obj:LTObject)="_dwlab_frmwork_LTXMLObject_ManageObject"
-ManageChildList%(List:TList Var)="_dwlab_frmwork_LTXMLObject_ManageChildList"
-ManageChildArray%(ChildArray:LTObject&[] Var)="_dwlab_frmwork_LTXMLObject_ManageChildArray"
-ManageChildMap%(Map:TMap Var)="_dwlab_frmwork_LTXMLObject_ManageChildMap"
-ManageChildSet%(Map:TMap Var)="_dwlab_frmwork_LTXMLObject_ManageChildSet"
...
-WriteObject%(File:TStream,Indent$=$"")="_dwlab_frmwork_LTXMLObject_WriteObject"
...
L_DeleteList%(List:TList)="dwlab_frmwork_L_DeleteList"
...
L_ClearPixmap%(Pixmap:TPixmap,Red!=0!,Green!=0!,Blue!=0!,Alpha!=1!)="dwlab_frmwork_L_ClearPixmap"
L_Round%(Value!)="dwlab_frmwork_L_Round"
L_Distance!(DX!,DY!)="dwlab_frmwork_L_Distance"
L_Distance2!(DX!,DY!)="dwlab_frmwork_L_Distance2"
L_Cathetus!(AB!,BC!)="dwlab_frmwork_L_Cathetus"
...
L_GetTypeID:TTypeId(TypeName$)="dwlab_frmwork_L_GetTypeID"
...
L_GetChunkLength%(Quantity%)="dwlab_frmwork_L_GetChunkLength"
L_Encode$(Value%,ChunkLength%)="dwlab_frmwork_L_Encode"
L_Decode%(Chunk$)="dwlab_frmwork_L_Decode"
LTRasterFrameVisualizer^LTVisualizer{
.Images:TImage&[,]&
.ImageFile$&
-New%()="_dwlab_frmwork_LTRasterFrameVisualizer_New"
-Delete%()="_dwlab_frmwork_LTRasterFrameVisualizer_Delete"
+GetFromFile:LTRasterFrameVisualizer(Filename$)="_dwlab_frmwork_LTRasterFrameVisualizer_GetFromFile"
+FromPixmap:LTRasterFrameVisualizer(Pixmap:TPixmap)="_dwlab_frmwork_LTRasterFrameVisualizer_FromPixmap"
-DrawUsingSprite%(Sprite:LTSprite,SpriteShape:LTSprite="bbNullObject")="_dwlab_frmwork_LTRasterFrameVisualizer_DrawUsingSprite"
}="dwlab_frmwork_LTRasterFrameVisualizer"
...
LTEmptyPrimitive^LTContourVisualizer{
...
L_IDMap:TMap&=mem:p("dwlab_frmwork_L_IDMap")
L_RemoveIDMap:TMap&=mem:p("dwlab_frmwork_L_RemoveIDMap")
L_MaxID%&=mem("dwlab_frmwork_L_MaxID")
L_IDArray:LTObject&[]&=mem:p("dwlab_frmwork_L_IDArray")
L_UndefinedObjects:TMap&=mem:p("dwlab_frmwork_L_UndefinedObjects")
...
L_ServiceTriangle:LTSprite&=mem:p("dwlab_frmwork_L_ServiceTriangle")
...
L_Controllers:TList&=mem:p("dwlab_frmwork_L_Controllers")
L_UndoStack:TList&=mem:p("dwlab_frmwork_L_UndoStack")
L_CurrentUndoList:TList&=mem:p("dwlab_frmwork_L_CurrentUndoList")
L_RedoStack:TList&=mem:p("dwlab_frmwork_L_RedoStack")
L_CurrentRedoList:TList&=mem:p("dwlab_frmwork_L_CurrentRedoList")
L_XMLMode%&=mem("dwlab_frmwork_L_XMLMode")
L_XMLVersion%&=mem("dwlab_frmwork_L_XMLVersion")
L_Log2!&=mem:d("dwlab_frmwork_L_Log2")
L_Log80!&=mem:d("dwlab_frmwork_L_Log80")
