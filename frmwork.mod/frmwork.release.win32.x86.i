...
+FromShape:LTSprite(X!,Y!,Width!=1!,Height!=1!,ShapeType%=2,Angle!=0!,Velocity!=1!)="_dwlab_frmwork_LTSprite_FromShape"
...
+FromColor:LTVisualizer(Red!,Green!,Blue!,Alpha!=1!)="_dwlab_frmwork_LTVisualizer_FromColor"
