...
Type TExample Extends LTProject
	...
	Method Logic()
		...
		If KeyDown( Key_NumAdd ) Then LogicFPS :+ PerSecond( 100 )
		If KeyDown( Key_NumSubtract ) And LogicFPS > 20 Then LogicFPS :- PerSecond( 100 )
	...
	Method Render()
		Sprite1.Draw()
		Sprite2.Draw()
		DrawText( "Logic FPS: " + L_TrimDouble( LogicFPS ) + ", press num+ / num- to change", 0, 0 )
	End Method
End Type