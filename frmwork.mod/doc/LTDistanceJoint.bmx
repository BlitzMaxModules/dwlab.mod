...
Type TExample Extends LTProject
	...
	Method Init()
		...
		Weight1.Visualizer = LTVisualizer.FromColor( 0.0, 1.0, 0.0 )
		Weight2.Visualizer = LTVisualizer.FromColor( 1.0, 1.0, 0.0 )
		Rope1.Visualizer = LTContourVisualizer.FromWidthAndColor( 0.25, 0.0, 0.0, 1.0, 1.0, 2.0 )
