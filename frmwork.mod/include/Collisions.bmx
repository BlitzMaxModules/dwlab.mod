...
Function L_OvalWithTriangle:Int( Oval:LTSprite, Triangle:LTSprite )
	If L_OvalWithRectangle( Oval, Triangle ) Then
		...
		If L_Line.DistanceTo( Oval ) < Oval.Width Then
			...
			If L_PivotWithRectangle( L_Pivot2, Triangle ) Then Return True
		End If
	End If
End Function
...
Function L_RectangleWithTriangle:Int( Rectangle:LTSprite, Triangle:LTSprite )
	If L_RectangleWithRectangle( Rectangle, Triangle ) Then
		Triangle.GetHypotenuse( L_Line )
		Triangle.GetRightAnglePivot( L_Pivot1 )
...
Function L_RasterWithRaster:Int( Raster1:LTSprite, Raster2:LTSprite )
...
Function L_CircleOverlapsPivot:Int( Circle:LTSprite, Pivot:LTSprite )
...
Function L_CircleOverlapsOval:Int( Circle:LTSprite, Oval:LTSprite )
	If Oval.Width = Oval.Height Then Return L_CircleOverlapsCircle( Circle, Oval )
	...
	If Oval.Width > Oval.Height Then
		...
		If Not L_CircleOverlapsCircle( Circle, L_Oval1 ) Then Return False
		L_Oval1.X = Oval.X + DWidth
	Else
		...
		L_Oval1.Y = Oval.Y + DHeight
	End If
	Return L_CircleOverlapsCircle( Circle, L_Oval1 )
End Function



Function L_CircleOverlapsCircle:Int( Circle1:LTSprite, Circle2:LTSprite )
