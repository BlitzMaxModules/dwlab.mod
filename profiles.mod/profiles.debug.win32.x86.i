...
+CreateDefault%(ProfileTypeID:brl.reflection.TTypeID)="_dwlab_profiles_LTProfile_CreateDefault"
...
-Flush%()="_dwlab_profiles_LTProfile_Flush"
...
L_PlaySound:brl.audio.TChannel(Sound:brl.audio.TSound,Volume!=1!,Rate!=1!,Pan!=0!,Depth!=0!)="dwlab_profiles_L_PlaySound"
L_PlayMusic:brl.audio.TChannel(Sound:brl.audio.TSound,Volume!=1!,Rate!=1!,Pan!=0!,Depth!=0!)="dwlab_profiles_L_PlayMusic"
