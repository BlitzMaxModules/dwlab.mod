...
Function CreateEnemyGeneratorImage()
  Local Circle:LTDoubleMap[] = New LTDoubleMap[ 18 ]
  For Local N:Int = 0 Until 18
    Circle[ N ] = New LTDoubleMap
  ...
  For Local Angle:Double = 0.0 Until 180.0 Step 5.0
    Cls
    For Local Angle2:Double = 0.0 To L_LimitDouble( Angle, 0.0, 90.0 )
      For Local DAngle:Double = 0.0  To 270.0 Step 90.0
        Local Frame:Int = Int( Angle / 5.0 )
        Local X:Double = 24.0 - 24.0 * Cos( Angle + DAngle + Angle2 - L_LimitDouble( Angle, 0.0, 90.0 ) ) + 64 * ( Frame Mod 8 )
        Local Y:Double = 24.0 - 24.0 * Sin( Angle + DAngle + Angle2 - L_LimitDouble( Angle, 0.0, 90.0 ) ) + 64 * Int( Frame / 8 )
